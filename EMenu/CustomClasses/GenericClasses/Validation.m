...
+ (BOOL) isValidEmailAddress:(NSString *)emailAddress{
    ...
    if(!result){
        UIAlertView* alert = [[UIAlertView alloc] initWithTitle:@"Email Field" message:ALERT_INVALID_EMAIL delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
        [alert show];
    }
    return result;
}
+(BOOL)isPasswordLength:(NSString*)password minCharacters:(int)minCharacters{
    ...
    if(!result){
        UIAlertView* alert = [[UIAlertView alloc] initWithTitle:@"Password Field" message:[NSString stringWithFormat:ALERT_PASSWORD_MINIMUM_CHARACTERS,minCharacters] delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
        [alert show];
    }
    return result;
}
...
+(BOOL)containsAlphabetOnly:(NSString*)str fieldName:(NSString*)fieldName{
    ...
    if(!result){
        UIAlertView* alert = [[UIAlertView alloc] initWithTitle:[NSString stringWithFormat:@"%@ Field",fieldName] message:[NSString stringWithFormat:ALERT_ALPHABETS_ALLOWED] delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
        [alert show];
    }
    return result;
}
...
+(BOOL)isValidPassword:(NSString*)password confirmPassword:(NSString*)confirmPassword{
    ...
    if(![password isEqualToString:confirmPassword]){
        UIAlertView* alert = [[UIAlertView alloc] initWithTitle:@"Error" message:[NSString stringWithFormat:ALERT_PASSWORD_MISMATCH] delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
        [alert show];
        return NO;
    }
    return YES;
...
+(BOOL)ValidateNumber:(NSString*)myStr fieldName:(NSString*)fieldName{
    ...
    if(!result){
        UIAlertView* alert = [[UIAlertView alloc] initWithTitle:[NSString stringWithFormat:@"%@ Field",fieldName] message:ALERT_INVLALID_CONTACT delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
        [alert show];
    }
    return result;
}
