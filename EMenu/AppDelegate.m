...
-(void)setRootMenuController {
    ...
    UINavigationController *navController =[storyboard instantiateViewControllerWithIdentifier:@"categoryNavigationController"];
   // MenuController *controller = [storyboard instantiateViewControllerWithIdentifier:@"menuController"];
...
-(void)setRootLoginController {
    ...
    UIStoryboard *storyboard = [UIStoryboard storyboardWithName:@"Main" bundle:nil];
    LoginController *controller = [storyboard instantiateViewControllerWithIdentifier:@"loginController"];
